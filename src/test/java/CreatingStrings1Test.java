...
public class CreatingStrings1Test {
    @Test
    public void solve() throws IOException {
        // CHANGE ME
        String testName = "creatingStrings1Test/";
        CreatingStrings1.Task solver = new CreatingStrings1.Task();
        CreatingStrings1.InputReader in;
        // END CHANGE ME
        ...
        in = new CreatingStrings1.InputReader(new FileInputStream(inputFile));
